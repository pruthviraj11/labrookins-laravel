...
class UsersController extends Controller
{
    ...
    public function getAll()
    {
        ...
        return DataTables::of($users)->addColumn('full_name', function ($row) {
            ...
            $updateButton = "<a data-bs-toggle='tooltip' title='Edit' data-bs-delay='400' class='btn-sm border-warning'  href='" . route('app-users-edit', $encryptedId) . "'><i class='text-secondary' data-feather='edit'></i></a>";
