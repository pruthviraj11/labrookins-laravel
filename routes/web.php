...
use App\Http\Controllers\AllPageBannerController;
...
Route::prefix('app')->middleware(['auth'])->group(function () {
  // Events Routes
  Route::get('all_page_banner/list', [AllPageBannerController::class, 'index'])->name('app-all_page_banner-list');
  Route::get('all_page_banner/getAll', [AllPageBannerController::class, 'getAll'])->name('app-all_page_banner-get-all');
  Route::post('all_page_banner/store', [AllPageBannerController::class, 'store'])->name('app-all_page_banner-store');
  Route::get('all_page_banner/add', [AllPageBannerController::class, 'create'])->name('app-all_page_banner-add');
  Route::get('all_page_banner/edit/{encrypted_id}', [AllPageBannerController::class, 'edit'])->name('app-all_page_banner-edit');
  Route::put('all_page_banner/update/{encrypted_id}', [AllPageBannerController::class, 'update'])->name('app-all_page_banner-update');
  Route::get('all_page_banner/destroy/{encrypted_id}', [AllPageBannerController::class, 'destroy'])->name('app-all_page_banner-delete');
...
Route::prefix('app')->middleware(['auth'])->group(function () {
  Route::get('devotional/list', [DevotionalController::class, 'index'])->name('devotional.list');
  Route::get('devotional/getAll', [DevotionalController::class, 'getAll'])->name('devotional.getAll');
  Route::get('devotional/add', [DevotionalController::class, 'create'])->name('devotional.add');
  Route::post('devotional/store', [DevotionalController::class, 'store'])->name('devotional.store');
  Route::get('devotional/edit/{encrypted_id}', [DevotionalController::class, 'edit'])->name('devotional.edit');
  Route::put('devotional/update/{encrypted_id}', [DevotionalController::class, 'update'])->name('devotional.update');
  Route::get('devotional/destroy/{encrypted_id}', [DevotionalController::class, 'destroy'])->name('devotional.delete');
});
...
Route::prefix('app')->middleware(['auth'])->group(function () {
  ...
  Route::get('categories/edit/{encrypted_id}', [CategoryController::class, 'edit'])->name('categories.edit');
  Route::put('categories/update/{encrypted_id}', [CategoryController::class, 'update'])->name('categories.update');
  Route::get('categories/destroy/{encrypted_id}', [CategoryController::class, 'destroy'])->name('categories.delete');
});

Route::prefix('itinerary')->group(function () {
  Route::get('/', [ItineraryController::class, 'index'])->name('itinerary.list');
  Route::get('/data', [ItineraryController::class, 'getData'])->name('itinerary.data');
  ...
  Route::delete('/delete/{id}', [ItineraryController::class, 'destroy'])->name('itinerary.destroy');

});

Route::prefix('app')->middleware(['auth'])->group(function () {
  Route::get('orders/list', [OrderDetailController::class, 'index'])->name('orders.index');
...
Route::get('store/update_products/list', [ProductController::class, 'updateProductsList'])->name('store.update_products.list');
Route::post('store/update_products/sync', [ProductController::class, 'syncProductsList'])->name('store.update_products.sync');
