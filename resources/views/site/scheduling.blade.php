...
@section('title', 'Scheduling | L.A. BROOKINS MINISTRIES')
                ...
                <div class="col-md-12">
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide">
                            ...
                            @else
                                <img src="{{ asset('assets/img/aboutpage.jpg') }}" class="img-fluid"
            ...
            <form action="{{ route('scheduling.submit') }}" method="POST">
                ...
                <div class="formbox">
                    ...
                    <div class="row formspace">
                        ...
                        <div class="col-xl-7">
                            <textarea name="scomment" rows="5" class="form-control"></textarea>
                        </div>
                    </div>
