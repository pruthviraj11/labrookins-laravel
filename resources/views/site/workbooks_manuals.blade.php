...
@section('title', 'Workbooks & Manuals | L.A. BROOKINS MINISTRIES')
                ...
                <div class="col-md-12">
                    <div class="swiper-wrapper align-items-center">
                        <div class="swiper-slide">
                            ...
                            @else
                                <img src="{{ asset('assets/img/books_banner.png') }}" class="img-fluid" alt="Banner">
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-10 CountSection">
                        <p>Showing {{ $books->count() }} of {{ $books->total() }} results</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row mainData">
                @forelse($books as $book)
                    <div class="col-md-3 mt-3 product">
                        ...
                        <a href="#" class="viewCart_{{ $book->id }}" style="display:none;">View cart</a> --}}
